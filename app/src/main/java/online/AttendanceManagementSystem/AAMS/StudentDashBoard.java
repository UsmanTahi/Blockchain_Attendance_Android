...
public class StudentDashBoard extends AppCompatActivity {
    ...
    String teacherID,myName, myRoll, myIMEI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRoll = ss.getString(1);
        myIMEI = ss.getString(8);

        sendsDetailsString = myName + "#" + myRoll + "#" + myIMEI;
        ...
        switch (menuItem.getItemId()) {
            case R.id.logout:
                ...
                new AlertDialog.Builder(StudentDashBoard.this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                sDB.clearTable();
                                startActivity(new Intent(StudentDashBoard.this, StudentRegistration.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                                finish();
                            }
                        })
            ...
            case R.id.sInfo:
                ...
                if(c!=null && c.getCount()>0){
                    ...
                    startActivity(new Intent(StudentDashBoard.this, StudentVerification.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                    finish();
            ...
            case R.id.verify:
                ...
                startActivity(new Intent(StudentDashBoard.this, StudentVerification.class));
                break;
        }
